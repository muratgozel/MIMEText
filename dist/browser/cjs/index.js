...
var MIMEMessage = /*#__PURE__*/function () {
  ...
  _createClass__default["default"](MIMEMessage, [{
    ...
    value: function asRawMixed(lines) {
      ...
      var attachments = _mapInstanceProperty__default["default"](_context23 = this.getAttachments()).call(_context23, function (a) {
        return a.dump(_this2.envctx, _this2.boundaries);
      }).join('').replace(/[\r\n]$/g, '');

      lines = _concatInstanceProperty__default["default"](_context24 = _concatInstanceProperty__default["default"](_context25 = _concatInstanceProperty__default["default"](_context26 = _concatInstanceProperty__default["default"](_context27 = _concatInstanceProperty__default["default"](_context28 = "".concat(lines, "\nContent-Type: multipart/mixed; boundary=")).call(_context28, this.boundaries.mixed, "\n\n--")).call(_context27, this.boundaries.mixed, "\n")).call(_context26, message.dump(this.envctx, this.boundaries), "\n\n")).call(_context25, attachments, "\n\n--")).call(_context24, this.boundaries.mixed, "--");
      return lines;
    }
  }, {
    key: "asRawMixedAlt",
