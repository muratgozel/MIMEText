  ...
  _createClass__default["default"](MIMEMessageHeader, [{
    ...
    value: function validateLength(name, value) {
      ...
      if (len > this.maxLineLength) {
        throw new MIMETextError('INVALID_HEADER', "The \"".concat(item.name, "\" header is too long. ")(_templateObject || (_templateObject = _taggedTemplateLiteral__default["default"](["", " chars allowed at max, \"", "\" was ", " long."])), this.maxLineLength, item.name, len));
      }
    }
  }, {
    key: "get",
...
var MIMEMessageContent = /*#__PURE__*/function () {
  ...
  _createClass__default["default"](MIMEMessageContent, [{
    ...
    value: function configureLineLength(text) {
      var _context2,
        _this2 = this;
      return _mapInstanceProperty__default["default"](_context2 = text.split(/[\r\n]+/)).call(_context2, function (line) {
        var _context3;
        return !line ? '' : _mapInstanceProperty__default["default"](_context3 = chunk(runesExports(line), _this2.maxLineLen)).call(_context3, function (arr) {
          return arr.join('');
        }).join("\r\n");
      }).join("\r\n");
    }
    ...
    value: function dump(envctx, boundaries) {
      ...
      if (this.isAttachment()) {
        ...
        return _concatInstanceProperty__default["default"](_context4 = _concatInstanceProperty__default["default"](_context5 = "--".concat(boundaries.mixed, "\n")).call(_context5, headerBlock, "\n\n")).call(_context4, this.configureLineLength(this.data), "\n");
      } else {
        var _context6;
        return _concatInstanceProperty__default["default"](_context6 = "".concat(headerBlock, "\r\n\r\n")).call(_context6, this.configureLineLength(this.data));
      }
    }
  }]);
